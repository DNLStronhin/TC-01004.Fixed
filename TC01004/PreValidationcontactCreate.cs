        ...
        protected override void ExecuteCdsPlugin(ILocalPluginContext localContext)
        {
            ...
            { 
                    ...
                    context.InputParameters["Target"] is EntityReference)
                {
                    ...
                    testCustomAction.Parameters.Add("Subject", $"Account has been associated {account.GetAttributeValue<string>("name")} with contact {contact.GetAttributeValue<string>("fullname")}");
                    testCustomAction.Parameters.Add("Body", $"Account has been added - https://orgd517a8d5.crm11.dynamics.com/main.aspx?appid=30cf0aa1-1d32-ef11-8e4e-6045bd0d3e34&pagetype=entityrecord&etn=account&id={accountRefs[0].Id}");
